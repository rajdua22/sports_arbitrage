...
clf1 = VotingClassifier(estimators=[
         ('lr', clf), ('rf', clf2), ('gnb', clf3), ('ada', clf4)], voting='hard')
...
predTrain.to_csv('E_LR__RF_NB_ADA.csv', float_format='%.0f')
...
pd.DataFrame(CM).to_csv("E_LR__RF_NB_ADA(CM).csv")
...
submission.to_csv('Sub_E_LR_RF_NB_ADA.csv', float_format='%.0f')
