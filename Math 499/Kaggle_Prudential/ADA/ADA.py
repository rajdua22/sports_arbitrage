...
# -*- coding: utf-8 -*-
"""
Created on Tue Sep 17 02:41:09 2019
...
predTrain.to_csv('ADA.csv', float_format='%.0f')
...
pd.DataFrame(CM).to_csv("ADA(CM).csv")
...
submission.to_csv('Sub_ADA.csv', float_format='%.0f')