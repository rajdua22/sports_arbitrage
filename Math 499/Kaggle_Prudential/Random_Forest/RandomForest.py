...
# -*- coding: utf-8 -*-
"""
Created on Tue Sep 17 02:31:28 2019
...
predTrain.to_csv('RandomF_orest.csv', float_format='%.0f')
...
pd.DataFrame(CM).to_csv("Random_Forest(CM).csv")
...
submission.to_csv('Sub_Random_Forest.csv', float_format='%.0f')