...
# -*- coding: utf-8 -*-
"""
Created on Tue Sep 17 02:47:31 2019
...
clf1 = ExtraTreesClassifier(n_estimators=100, max_depth=20,
...
predTrain.to_csv('Extra_Trees.csv', float_format='%.0f')
...
pd.DataFrame(CM).to_csv("Extra_Trees(CM).csv")
...
submission.to_csv('Sub_Extra_Trees.csv', float_format='%.0f')
