...
# -*- coding: utf-8 -*-
"""
Created on Tue Sep 17 02:37:49 2019
...
predTrain.to_csv('Naive_Bayes.csv', float_format='%.0f')
...
pd.DataFrame(CM).to_csv("Naive_Bayes(CM).csv")
...
submission.to_csv('Sub_Naive_Bayes.csv', float_format='%.0f')