...
# -*- coding: utf-8 -*-
"""
Created on Tue Sep 17 00:52:34 2019
...
predTrain.to_csv('Logistic_Regression.csv', float_format='%.0f')
...
pd.DataFrame(CM).to_csv("Logistic_Rgression(CM).csv")
...
submission.to_csv('Sub_Logistic_Regression.csv', float_format='%.0f')
